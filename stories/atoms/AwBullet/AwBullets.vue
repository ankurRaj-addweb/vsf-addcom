<template functional>
  <ol
    :class="[data.class, data.staticClass, 'aw-bullets']"
  ...
  >
    ...
    >
      <slot name="inactive" class="aw-bullet" v-bind="{ index, $options }">
        <li :key="index">
          <component
            :is="injections.components.AwButton"
            class="aw-button--pure aw-bullet"
            type="button"
    ...
    <slot name="active">
      <li>
        <component
          ...
          class="aw-button--pure aw-bullet is-active"
        ></component>
      </li>
    </slot>
    <template
