...
export default {
  ...
  argTypes: {
    classes: {
      control: {
        type: "select",
        options: ["", "aw-input--filled", "aw-input--outline"],
      },
      table: {
    ...
    icon: {
      ...
      description:
        "The icon configuration object which can have props: icon name, size and color as AwIcon specifies.",
    },
    value: {
      control: "text",
      table: {
...
Filled.args = {
  ...Common.args,
  classes: "aw-input--filled",
  value: "Storefront",
};

export const WithLabelSlot = (args, { argTypes }) => ({
  components: { AwInput, AwIcon },
  props: Object.keys(argTypes),
  data() {
    return {
      inputValue: this.value,
...
export const WithErrorSlot = (args, { argTypes }) => ({
  ...
  <AwInput
    ...
    <template #error-message="{errorMessage}">
      <div>
        <AwIcon icon="info_shield" size="10px" color="#E22326" style="margin-right: 4px; display: inline-block"/> 
