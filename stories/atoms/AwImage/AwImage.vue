<template>
  <span class="aw-image--wrapper" data-testid="image-wrapper">
    <component
    ...
    <noscript inline-template>
      <img
        :src="src"
        :alt="alt"
        class="aw-image aw-image-loaded"
        v-bind="$attrs"
        :width="width"
        :height="height"
      />
...
<script>
// import imagePlaceholder from "../static/AwImage/placeholder.png";
...
export default {
  ...
  computed: {
    ...
    classes() {
      if (this.loaded) {
        return "aw-image aw-image-loaded";
      } else {
        return "aw-image";
      }
    },
