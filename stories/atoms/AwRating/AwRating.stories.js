...
import AwRating from "./AwRating.vue";
...
const Template = (args, { argTypes }) => ({
  ...
  template: `<AwRating :max="max" :score="score" :icon="icon" />`,
});
...
export const ChangedColors = (args, { argTypes }) => ({
  components: { AwRating, AwIcon },
  props: Object.keys(argTypes),
  template: `
  <AwRating style="--icon-color: gold; --icon-color-negative: pink;" :max="max" :score="score" :icon="icon" />`,
});
