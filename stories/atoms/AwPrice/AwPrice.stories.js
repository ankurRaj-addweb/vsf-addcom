// import { AwPrice, AwBadge } from "./AwPrice.vue";
import AwPrice from "./AwPrice.vue";
import AwBadge from "./AwPrice.vue";
// import {SfBadge} from "../packages/shared/styles/components/atoms/SfBadge.scss";
...
const Template = (args, { argTypes }) => ({
  ...
  template: `<AwPrice :special="special" :regular="regular" />`,
});
...
export const WithSpecialSlot = (args, { argTypes }) => ({
  ...
  <AwPrice
    ...
    <template #special="{props}">
      <AwBadge class="color-warning">{{special}}</AwBadge>
    </template>  
  </AwPrice>`,
});
...
export const WithOldSlot = (args, { argTypes }) => ({
  ...
  <AwPrice
    ...
    :special="special">
    <template #old="{props}">
      <AwBadge class="color-warning">{{regular}}</AwBadge>
    </template>
  </AwPrice>`,
});
WithOldSlot.args = {
