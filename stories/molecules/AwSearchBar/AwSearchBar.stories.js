  ...
  argTypes: {
    classes: {
      control: {
        ...
        options: [
          "",
          "aw-search-bar--position-center",
          "aw-search-bar--no-icon",
        ],
      },
      table: {
...
HideIconCSS.args = {
  ...WithIcon.args,
  classes: "aw-search-bar--no-icon",
};

export const Centered = Template.bind({});
Centered.args = {
  ...WithIcon.args,
  classes: "aw-search-bar--position-center",
};
