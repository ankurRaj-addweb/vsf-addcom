...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Native select component. Built from main component - AwSelect and internal component - AwSelectOption.",
      },
    },
  },
  argTypes: {
    ...
    value: {
      control: "text",
      table: {
        category: "Props for AwSelectOption component",
        type: {
    ...
    "default ": {
      ...
      description:
        "Default slot for `AwSelectOption` component. Use this slot to place options in `AwSelect` component",
    },
    "label ": {
      table: {
        category: "Slots",
...
const Template = (args, { argTypes }) => ({
  ...
  >
    <AwSelectOption v-for="(option, key) in options" :key="key" :value="option.value">
      {{option.label}}
    </AwSelectOption>
  </AwSelect>`,
});
