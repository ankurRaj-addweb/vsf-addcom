<template>
  <div
    ...
    :data-testid="name"
  >
    <label class="aw-checkbox__container">
      <input
        v-focus
        type="checkbox"
        :name="name"
      ...
      <slot name="checkmark" v-bind="{ isChecked, disabled }">
        <span
          class="aw-checkbox__checkmark"
          :class="{ 'aw-checkbox__checkmark is-active': isChecked }"
        >
          <AwIcon
      ...
      <slot name="label" v-bind="{ label, isChecked, disabled }">
        <span :class="{ 'display-none': !label }" class="aw-checkbox__label">{{
          label
        }}</span>
      </slot>
    </label>
    <div class="aw-checkbox__message">
...
export default {
  ...
  computed: {
    ...
    computedMessageClass() {
      return this.messagesHandler(
        "aw-checkbox__message--error",
        "aw-checkbox__message--info",
        this.required ? "aw-checkbox__message--hint" : ""
      );
    },
  },
  methods: {
