    ...
    >
      ...
      <div>
        <slot name="title" v-bind="{ title }">
          <div
            ...
            class="aw-notification__title smartphone-only"
          >
            {{ title }}
          </div>
        </slot>
        <slot name="message" v-bind="{ message }">
          <span
            ...
            class="aw-notification__message"
            >{{ message }}</span
          >
        </slot>
        <slot name="action" v-bind="{ action, actionHandler }">
          <awButton
            ...
            class="aw-button--pure aw-notification__action"
            @click="actionHandler"
          >
            {{ action }}
          </awButton>
      ...
      <slot name="close" v-bind="{ closeHandler }">
        <AwButton
          ...
          class="aw-button--pure aw-notification__close"
          @click="closeHandler"
        >
