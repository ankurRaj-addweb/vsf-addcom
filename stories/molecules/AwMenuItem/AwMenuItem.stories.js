...
export default {
  ...
  argTypes: {
    ...
    link: {
      ...
      description: "Menu-item link (if is empty then AwMenuItem is AwButton)",
    },
    "icon ": {
      table: {
        category: "Slots",
...
export const UseMobileNavIconSlot = (args, { argTypes }) => ({
  ...
  <AwMenuItem
    ...
    <template #mobile-nav-icon="{icon}">
      <AwIcon icon="arrow_right" size="xxs" style="margin-left: 0.625rem"/>
    </template>
  </AwMenuItem>`,
});
