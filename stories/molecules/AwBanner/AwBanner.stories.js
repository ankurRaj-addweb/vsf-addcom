...
export default {
  ...
  argTypes: {
    ...
    "img-tag": {
      ...
      description:
        "Slot dedicated to `img` tags or other components with this tag (e.g. `AwImage`, `AwCimage`) that can be used as images for background. If you want to use this slot, make sure that `background` and `image` props are NOT provided.",
    },
  },
  args: {
    image: banner,
