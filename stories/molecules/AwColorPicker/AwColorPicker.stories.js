...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "ColorPicker component utilizing [AwButton](https://docs.storefrontui.io/?path=/story/components-atoms-button--primary) with slot for [AwColor](https://docs.storefrontui.io/?path=/story/components-atoms-color--common) component",
      },
    },
  },
  decorators: [
  ...
  argTypes: {
    classes: {
      control: {
        type: "select",
        options: [
          "aw-color-picker--vertical",
          "aw-color-picker--left aw-color-picker--vertical",
          "",
        ],
      },
      table: {
...
const Template = (args, { argTypes }) => ({
  components: { AwColorPicker, AwColor },
  ...
  >
    <AwColor style="margin: 0.4375rem" v-for="color in colors" :key="color.value" :color="color.color" :selected="color.selected" @click="color.selected = !color.selected"/>
  </AwColorPicker>`,
});
...
VerticalDisplay.args = {
  ...WithCloseBtn.args,
  classes: "aw-color-picker--vertical",
};

export const VerticalLeftDisplay = Template.bind({});
VerticalLeftDisplay.args = {
  ...WithCloseBtn.args,
  classes: "aw-color-picker--left aw-color-picker--vertical",
};
