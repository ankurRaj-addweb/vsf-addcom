...
export default {
  ...
  argTypes: {
    ...
    steps: {
      ...
      description:
        "Steps to display (only for testing puropses). Add steps using AwStep component.",
    },
    name: {
      control: "text",
      table: {
        category: "Props for AwStep component",
        defaultValue: {
          summary: "",
        },
      },
    ...
    default: {
      ...
      description:
        "Default slot for `AwSteps` component. Slot to replace steps content ",
    },
    "steps ": {
      table: {
        category: "Slots",
    ...
    "default ": {
      ...
      description:
        "Default slot for `AwStep` component. Use this slot to customize step in `AwStep` component",
    },
  },
};
...
const Template = (args, { argTypes }) => ({
  ...
  <AwSteps
    ...
    @change="change"
  >
    <AwStep v-for="(step, key) in steps" :key="key" :name="step">
