  ...
  <div class="aw-steps">
    <div class="aw-steps__header">
      ...
      >
        ...
        >
          <span class="aw-steps__title">{{ step.step }}</span>
        </AwButton>
      </slot>
      <div
        class="aw-steps__progress"
        :style="progress"
        data-testid="steps-progress"
      ></div>
    </div>
    <div class="aw-steps__content">
      <slot />
    </div>
  </div>
</template>
<script>
import Vue from "vue";
import AwStep from "./_internal/AwStep.vue";
import AwButton from "../../atoms/AwButton/AwButton.vue";
Vue.component("AwStep", AwStep);
export default {
  name: "AwSteps",
  components: {
    AwButton,
