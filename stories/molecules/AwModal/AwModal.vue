<template>
  <section class="aw-modal" :class="[staticClass, className]">
    <AwOverlay
      v-if="overlay"
      class="aw-modal__overlay"
    ...
    <transition :name="transitionModal">
      <div
        ...
        class="aw-modal__container"
      >
        <slot name="modal-bar">
          <AwBar
            class="aw-modal__bar smartphone-only"
            :close="cross"
            :title="title"
            @click:close="close"
          />
        ...
        <AwButton
          ...
          class="aw-button--pure aw-modal__close desktop-only"
        ...
        <div ref="content" class="aw-modal__content">
          <slot />
        </div>
      </div>
    </transition>
