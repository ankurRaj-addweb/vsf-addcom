  ...
  argTypes: {
    classes: {
      control: {
        ...
        options: [
          "",
          "aw-hero-item--position-bg-top-right",
          "aw-hero-item--position-bg-bottom-right",
          "aw-hero-item--position-bg-bottom-left",
          "aw-hero-item--align-right",
        ],
      },
      table: {
...
const Template = (args, { argTypes }) => ({
  ...
  data() {
    return {
      ...
      imageUrl: require('../../../static/AwHero/Hero.jpg'),
