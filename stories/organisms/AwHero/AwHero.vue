  ...
  <div class="aw-hero">
    <div ref="glide" class="glide">
      <div class="glide__track" data-glide-el="track">
        <ul class="glide__slides aw-hero__slides">
          <slot />
        </ul>
      </div>
    </div>
    <div
      ...
      class="aw-hero__control--left"
    >
      <slot name="prev" v-bind="{ go: () => go('prev') }">
        <AwArrow
          class="aw-arrow aw-arrow--transparent"
          aria-label="previous"
    ...
    <div
      :class="{ 'display-none': numberOfPages <= 1 }"
      class="aw-hero__control--right"
    >
      <slot name="next" v-bind="{ go: () => go('next') }">
        <AwArrow
          class="aw-arrow aw-arrow--right aw-arrow--transparent"
          aria-label="next"
