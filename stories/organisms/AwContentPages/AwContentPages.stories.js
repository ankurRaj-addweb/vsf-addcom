...
import AwTabs from "../AwTabs/AwTabs.vue"
...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "The content pages for static content. Built from main component - AwContentPages and internal components - AwContentCategory and AwContentPage.",
      },
    },
    layout: "fullscreen",
  },
  argTypes: {
    ...
    icon: {
      ...
      table: {
        category: "Props for AwContentPage component",
        type: {
    ...
    title: {
      control: "text",
      table: {
        category: "Props for AwContentCategory component",
        type: {
          summary: "string",
        },
        defaultValue: {
    ...
    default: {
      ...
      description:
        "Default slot for `AwContentPages` component. Use this slot to place content pages items",
    },
    "menu-item": {
      table: {
        category: "Slots",
      ...
      description:
        "Named slot for `AwContentPages` component. Use this slot to replace menu item element",
    },
    "default ": {
      table: {
        category: "Slots",
      ...
      description:
        "Default slot for `AwContentCategory` component. Use this slot to place categories content",
    },
    "default  ": {
      table: {
        category: "Slots",
      ...
      description:
        "Default slot for `AwContentPage` component. Use this slot to place page content",
    },
  },
};

const Template = (args, { argTypes }) => ({
  components: { AwContentPages, AwTabs },
  ...
  >
  <AwContentPage v-for="(page, key) in pages" :key="page.title+key" :title="page.title">
    <AwTabs v-if="page.tabs" :open-tab="1">
      <AwTab v-for="(tab, key) in page.tabs" :key="tab.title+key" :title="tab.title">{{tab.content}}</AwTab>
    </AwTabs>
...
export const WithCategoryIcon = (args, { argTypes }) => ({
  ...
  <AwContentPages
    ...
    @click:change="(active) => { this['click:change'](active); this.opened = active }"
  >
    <AwContentPage v-for="(page, key) in pages" :key="page.title+key" :title="page.title" :icon="page.icon">
    <AwTabs v-if="page.tabs" :open-tab="1">
      <AwTab v-for="(tab, key) in page.tabs" :key="tab.title+key" :title="tab.title">{{tab.content}}</AwTab>
    </AwTabs>
