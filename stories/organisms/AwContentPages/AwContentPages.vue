<template>
  <div class="aw-content-pages">
    ...
    <section
      ...
      class="aw-content-pages__section"
    >
      <div class="aw-content-pages__sidebar">
        <h1 class="aw-content-pages__title desktop-only">{{ title }}</h1>
        <div
      ...
      <div class="aw-content-pages__content">
        <slot />
      </div>
    </section>
  </div>
