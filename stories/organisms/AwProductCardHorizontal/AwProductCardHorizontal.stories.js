...
import AwSelect from '../../molecules/AwSelect/AwSelect.vue';
...
import AwButton from '../../atoms/AwButton/AwButton.vue';
  ...
  export default {
    ...
    component: AwProductCardHorizontal,
    parameters: {
  ...
  const Template = (args, { argTypes }) => ({
    components: { AwProductCardHorizontal, AwSelect, AwProductOption, AwButton },
    ...
    >
      <template #configuration>
        <div style="display: flex; flex-direction: column; justify-content: flex-end">
          ...
          >
            <AwSelectOption v-for="(val, key) in valSelects.options" :key="key" :value="key">
              {{ val }}
            </AwSelectOption>
          </AwSelect>
        </div>
      ...
      <template #actions>
          <AwButton
            class="aw-button--text desktop-only"
  ...
  Common.args = {
    ...
    maxRating: 5,
    reviewsCount: 7,
    image: require('../../../static/AwImage/product-216x326.jpg'),
    imageWidth: 140,
    imageHeight: 200,
  };
  ...
  WithMultipleImages.args = {
    ...Common.args,
    image: [
      require("../../../static/AwImage/product-216x326.jpg"),
      require("../../../static/AwImage/product-216x326.jpg"),
    ],
  };
