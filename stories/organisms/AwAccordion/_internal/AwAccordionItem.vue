  ...
  <div class="aw-accordion-item">
    ...
    >
      <AwButton
        ...
        class="aw-button--pure aw-accordion-item__header"
      ...
      >
        ...
        <AwChevron
          tabindex="0"
          class="aw-accordion-item__chevron"
          :class="{ 'aw-chevron--right': !isOpen }"
        />
      </AwButton>
    </slot>
    <AwTransition :transition="$parent.transition">
      <div v-if="isOpen">
        <div class="aw-accordion-item__content">
          <slot />
        </div>
      </div>
    </AwTransition>
