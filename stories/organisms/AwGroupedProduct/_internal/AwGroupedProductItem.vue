<template>
  <li class="glide__slide aw-grouped-product-item">
    <div class="aw-grouped-product-item__aside">
      <slot
        name="image"
        v-bind="{
          image,
      ...
      >
        <AwImage
          ...
          class="aw-grouped-product-item__image"
        />
      </slot>
    </div>
    <div class="aw-grouped-product-item__description">
      <slot name="title" v-bind="{ title }">
        <div class="aw-grouped-product-item__title-wraper">
          <AwLink :link="link" class="aw-grouped-product-item__title">{{
            title
          }}</AwLink>
        </div>
      </slot>
    ...
    <slot name="input" v-bind="{ qty }">
      <AwQuantitySelector
        :qty="qty"
        aria-label="Quantity"
        class="aw-grouped-product-item__quantity-selector"
