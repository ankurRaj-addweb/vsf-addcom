...
import AwGroupedProductItem from "./_internal/AwGroupedProductItem.vue";

export default {
  title: "Components/Organisms/GroupedProduct",
  component: AwGroupedProductItem,
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Grouped Product component. Built from main component - AwGroupedProduct and internal component - AwGroupedProductItem.",
      },
    },
  },
  argTypes: {
...
const Template = (args, { argTypes }) => ({
  components: { AwGroupedProduct, AwProperty },
  ...
  >
    ...
    >
      <template #details>
        ...
        <AwProperty name="Color" value="White" :style="{margin: 'auto 0 0 0'}" />
      </template>
    </AwGroupedProductItem>
  </AwGroupedProduct>`,
});
...
Common.args = {
  ...
  image: require('../../../static/AwGroupedProduct/product-109x164.jpg'),
  imageWidth: 82,
  imageHeight: 112,
