<template>
  <div class="aw-store-locator">
    <div class="aw-store-locator__wrapper">
      <div class="aw-store-locator__list">
        <div class="aw-store-locator__stores">
      ...
      <div class="aw-store-locator__map-wrapper">
        <LMap
          v-if="loaded"
          ref="map"
          class="aw-store-locator__map"
        ...
        <slot name="map-loading">
          <AwLoader
            ...
            class="aw-store-locator__loader"
          />
        </slot>
      </div>
    </div>
...
import AwLoader from "../../atoms/AwLoader/AwLoader.vue";
import AwStore from "./_internal/AwStore.vue";
Vue.component("AwStore", AwStore);
export default {
  name: "AwStoreLocator",
  provide() {
    const locatorData = {};
