import AwStoreLocator from "./SfStoreLocator.vue";
import AwStore from "./_internal/AwStore.vue";
...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Component locating and marking on map using tile data. Built from main component - AwStoreLocator and internal components - AwStoreLocatorItem.",
      },
    },
    layout: "fullscreen",
  },
  ...
  argTypes: {
    ...
    latlng: {
      control: "array",
      table: {
        category: "Props for AwStore component",
        type: {
          summary: "array",
        },
        defaultValue: {
    ...
    default: {
      ...
      description:
        "Default slot for `AwStoreLocator` component. Use this slot to show stores cards",
    },
    "marker-icon": {
      table: {
        category: "Slots",
      ...
      description:
        "Named slot for `AwStoreLocator` component. Use this slot to change the icon of the stores, remember to update `markerIconSize` and `markerIconAnchor` accordingly",
    },
    "map-loading": {
      table: {
        category: "Slots",
      ...
      description:
        "Named slot for `AwStoreLocator` component. Use this slot to customize the loading indicator while the map library loads",
    },
    "default ": {
      table: {
        category: "Slots",
      ...
      description:
        "Default slot for `AwStore` component. Use this slot to place information about store",
    },
    media: {
      table: {
        category: "Slots",
      ...
      description:
        "Named slot for `AwStore` component. Use this slot to show media elements",
    },
    heading: {
      table: {
        category: "Slots",
      ...
      description:
        "Named slot for `AwStore` component. Use this slot to replace name element",
    },
    distance: {
      table: {
        category: "Slots",
      ...
      description:
        "Named slot for `AwStore` component. Use this slot to replace distance element",
    },
  },
};

const Template = (args, { argTypes }) => ({
  components: { AwStoreLocator },
...
Common.args = {
  ...
  name: "Store",
  picture: "/assets/storybook/AwStore/storeA.png",
  pictureWidth: 82,
  pictureHeight: 112,
};
