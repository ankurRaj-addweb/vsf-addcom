...
export default {
  ...
  parameters: {
    ...
    docs: {
      ...
      description: {
        component:
          "Component with tab-related content.  Built from main component - AwTabs and internal component - AwTab.",
      },
    },
    layout: "fullscreen",
  },
  argTypes: {
    ...
    title: {
      control: "text",
      table: {
        category: "Props for AwTab component",
        type: {
          summary: "string",
        },
        defaultValue: {
    ...
    default: {
      ...
      description:
        "Default slot for `AwTabs` component. Use this slot to pass your tabs",
    },
    "default ": {
      table: {
        category: "Slots",
      ...
      description:
        "Default slot for `AwTab` component. Use this slot to place tab's content",
    },
    "title ": {
      table: {
        category: "Slots",
      ...
      description:
        "Named slot `title` for `AwTab` component. Use this slot to replace title element",
    },
  },
};
...
export const changeTabsWithButtons = (args, { argTypes }) => ({
  ...
  template: `<div>
  <AwButton style="display: inline; margin: var(--spacer-xs)" @click="change(1)">open tab 1</AwButton>
  <AwButton style="display: inline; margin: var(--spacer-xs)" @click="change(2)">open tab 2</AwButton>
  <AwButton style="display: inline; margin: var(--spacer-xs)" @click="change(3)">open tab 3</AwButton>
  <AwTabs
    :open-tab="open"
    :tabMaxContentHeight="tabMaxContentHeight"
    :tabShowText="tabShowText"
